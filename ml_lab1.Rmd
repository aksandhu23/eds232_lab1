...
**The data is clustered vertically for the different packages and the linear regression line does not make sense for this data as it doesn't represent the spread of the data.**
