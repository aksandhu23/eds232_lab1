...
**The package is most highly correlated with price, because it has a correlation of .6 which is closer to 1 rather compared to the other variables which has a correlation closer to 0.**
...
**The data is clustered vertically for the different packages and the linear regression line does not make sense as it doesn't represent the spread of the data.**
